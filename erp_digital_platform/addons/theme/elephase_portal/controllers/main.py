...
class WebsiteAccount(http.Controller):
    ...
    def account(self):
        ...
        return request.website.render('elephase_portal.account', values)
    ...
    def details(self, redirect=None, **post):
        ...
        return request.website.render('elephase_portal.details', values)
...
#         ])
    ...
    def quotations(self, **kw):
        ...
        return request.website.render(
            'elephase_portal.quotations_only', quotations)
