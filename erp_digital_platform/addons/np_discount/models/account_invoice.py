...
class NpAccountInvoice(models.Model):
    ...
    # amount_total = fields.Float(compute='_display_amount')
    # residual_display = fields.Float(compute='_display_amount', string='Bal Amt')
    base_residual = fields.Float()
    # base_residual_display = fields.Float(compute='_display_amount')
    ...
    total_before_discount = fields.Float(string='Total Amount', compute='_compute_amount',
...
class NpAccountInvoiceLine(models.Model):
    ...
    def move_line_get(self, invoice_id):
        res = super(NpAccountInvoiceLine, self).move_line_get(invoice_id)
