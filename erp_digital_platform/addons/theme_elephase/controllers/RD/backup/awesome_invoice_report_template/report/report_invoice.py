...
class invoice_parser(report_sxw.rml_parse):
    ...
    def __init__(self, cr, uid, name, context):
        super(invoice_parser, self).__init__(cr, uid, name, context)
...
class wrapped_invoice(osv.AbstractModel):
    _name = 'report.awesome_invoice_report_template.custom_report_invoice_document'
    _inherit = 'report.abstract_report'
    _template = 'awesome_invoice_report_template.custom_report_invoice_document'
