...
class AmountInWords(models.Model):
    ...
    amount_words= fields.Char('Amount in Words:', help="The sale order total or quotation total amount in words is automatically generated by the system..few languages are supported currently",                             compute='_compute_num2words')
    aiw_report = fields.Boolean('Show in report?', default=True,  help="If you want to display the sale order total or quotation in words in the report, then check this box")
