...
class ERPAPIVesselTypeModelInherit(models.Model):
    _inherit = 'vessel.type'

    @api.model
    def create(self, vals):
        res = super(ERPAPIVesselTypeModelInherit, self).create(vals)
    ...
    def write(self, vals):
        ...
        res = super(ERPAPIVesselTypeModelInherit, self).write(vals)
        return res
    ...
    def unlink(self):
        ...
        res = super(ERPAPIVesselTypeModelInherit, self).unlink()
        return res